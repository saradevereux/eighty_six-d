...
class SignUpForm(FlaskForm):
    ...
    password = PasswordField("Password", validators=[DataRequired(), EqualTo("confirm", message="Passwords must match"), Length(min=6, message="Passowrd must be at least 6 charecters")])
