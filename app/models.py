...
class User(db.Model, UserMixin):
    ...
    posts = db.relationship("Post", backref="user_posts", passive_deletes=True, lazy='dynamic')
...
class Post(db.Model):
    ...
    comments = db.relationship("Comment", backref="comments_post", passive_deletes=True, uselist=True)
...
class Business(db.Model):
    ...
    posts = db.relationship("Post", backref="business_posts", passive_deletes=True, lazy='dynamic')
